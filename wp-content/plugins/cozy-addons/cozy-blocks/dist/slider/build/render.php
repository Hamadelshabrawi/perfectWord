...
#$block_id .swiper-button-prev::after, #$block_id .swiper-button-next::after {
    font-size: {$attributes['navigation']['iconSize']}px;
}
#$block_id .swiper-button-prev, #$block_id .swiper-button-next {
...
#$block_id .swiper-button-prev:hover, #$block_id .swiper-button-next:hover {
...
#$block_id .swiper-pagination {
    bottom: var(--swiper-pagination-bottom, {$attributes['pagination']['bottom']}px);
}
