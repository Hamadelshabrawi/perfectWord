...
if ( ! class_exists( 'CozyBlockInit' ) ) {
	final class CozyBlockInit {
		...
		public function __construct() {
			...
			// add_filter( 'block_editor_settings_all', array( $this, 'cozy_addons_default_color_scheme' ) );
		...
		/**
		 * Setting up default plugin color scheme.
		 */
		public function cozy_addons_default_color_scheme( $settings ) {
			$settings['__experimentalFeatures']['color']['palette']['default'][] = array(
				'name'  => __( 'Transparent', 'cozy-addons' ),
				'slug'  => 'cozy-transparent',
				'color' => '#ffffff00',
			);
