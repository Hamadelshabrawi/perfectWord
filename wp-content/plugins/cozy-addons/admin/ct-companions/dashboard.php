			...
			<div class="dashboard-box">
				...
				<div class="dashboard-main">
					<div class="dasboard-content">
						...
						<h3><?php echo __( '30+ Advanced Blocks for FSE (Full Site Editing) and Gutenberg Editor with 130+ patterns library, 40+ Advanced Widgets for Elementor to Build Website with Powerful Features.', 'cozy-addons' ); ?></h3>
						<div class="cozy-dashboard-media">
							<img src="<?php echo COZY_ADDONS_PLUGIN_URL . '/admin/images/cozy-blocks-screen.png'; ?>" />
						</div>
						<p><?php echo __( 'Elevate your WordPress website with Cozy Blocks, a dynamic plugin designed to supercharge your design capabilities. Seamlessly integrate more than 30 advanced blocks and 130+ patterns library for Full Site Editing (FSE) and the Gutenberg Editor, allowing you to effortlessly craft visually stunning and feature-rich pages. With an extensive repertoire of over 40 advanced Elementor widgets, Cozy Blocks empowers you to create a truly customized and engaging online experience. Unleash the full potential of your WordPress site with Cozy Blocks and take your design game to the next level.', 'cozy-addons' ); ?></p>
					</div>
				...
				<ul class="blocks-holder">
					...
					<li>
						<div class="cozy-display-flex">
							<svg width="26" height="23" viewBox="0 0 26 23" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect fill="white" x="0.5" y="0.5" width="25" height="22" rx="2.5" stroke="#5566CA" />
								<path d="M4 3.5H22V13.5H4V3.5Z" fill="#B2BCF9" />
								<path d="M15.34 8.10001L16.6 10.2H12.82L15.34 8.10001Z" fill="#96A2EA" />
								<path d="M12.82 6L15.34 10.2H10.3L12.82 6Z" fill="#7689F6" />
								<path fill-rule="evenodd" clip-rule="evenodd" d="M20 17.5H6V16.5H13H20V17.5Z" fill="#B2BCF9" />
								<path fill-rule="evenodd" clip-rule="evenodd" d="M18 16H8V15H13H18V16Z" fill="#B2BCF9" />
								<path fill-rule="evenodd" clip-rule="evenodd" d="M18 19H8V18H13H18V19Z" fill="#B2BCF9" />
							</svg>

							<?php echo __( 'Featured Content Box', 'cozy-addons' ); ?>
						</div>
						<div class="cozy-block-toggle">
							<label class="switch">
